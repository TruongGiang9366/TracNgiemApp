...
class Succsess_page extends StatefulWidget {
  const Succsess_page({super.key});

  @override
  State<Succsess_page> createState() => _Succsess_pageState();
}

class _Succsess_pageState extends State<Succsess_page> {
  @override
